...
Network.prototype.get = function() {
	return this.client.get.apply(this.client, [{ network: this._name }].concat(_.toArray(arguments)));
};
 ...
 * @return {Network}
 */
Network.prototype.set = function() {
	this.client.set.apply(this.client, [{ network: this._name }].concat(_.toArray(arguments)));
	return this;
};
...
Network.prototype.emit = function() {
	return this.client.emit.apply(this.client, [{ network: this._name }].concat(arguments));
};
